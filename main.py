...
def print_intro():
    ...
    print(Fore.GREEN + "Created by zeeqrux".center(50))
    print(Fore.YELLOW + "=" * 50)
...
def scrape_instagram(username):
    ...
    print(Fore.YELLOW + "\n" + "=" * 50)
    print(Fore.RED + "Note: This tool is for educational purposes only. Respect privacy and adhere to Instagram's terms of service.".center(50))
    print(Fore.YELLOW + "=" * 50 + "\n")
